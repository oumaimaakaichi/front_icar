  ...
  Future<void> _fetchTickets() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://192.168.1.17:8000/api/tickets/technicien/${userData["id"]}'),
        headers: {
...
class __AddTicketFormState extends State<_AddTicketForm> {
  ...
  Future<void> _fetchTicketTypes() async {
    try {
      final response = await http.get(
        Uri.parse('http://192.168.1.17:8000/api/tickets/type'),
        headers: {
          'Accept': 'application/json',
        },
      );
  ...
  Future<void> _submitTicket() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://192.168.1.17:8000/api/tickets'),
        headers: {
