...
class _MesVoituresPageState extends State<MesVoituresPage> {
  ...
  Future<void> _loadCouleurs() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://192.168.1.17:8000/api/couleur'),
        headers: {
  ...
  Future<void> _loadEntreprises() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://192.168.1.17:8000/api/entreprises-with-voitures'),
        headers: {
          'Accept': 'application/json',
        },
      );
  ...
  Future<void> _fetchVoitures({int page = 1}) async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://192.168.1.17:8000/api/voiture/${userData["id"]}?page=$page'),
        headers: {
          'Accept': 'application/json',
        },
      );
  ...
  Future<void> _addVoiture(Map<String, dynamic> voitureData) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('http://192.168.1.17:8000/api/voitures'),
        headers: {
  ...
  Future<void> _updateVoiture(int id, Map<String, dynamic> voitureData) async {
    try {
      ...
      final response = await http.put(
        Uri.parse('http://192.168.1.17:8000/api/voitures/$id'),
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
        },
